      ...
      <section className="relative bg-[#0096ff] text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-20 pt-36 lg:px-8 lg:pb-28 lg:pt-44">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <Reveal delay={0.1}>
              <Image src="https://media.base44.com/images/public/6a66ade4f704833c85945c24/11e3d22d1_pic59.jpg" alt="Three girls playing with the cardboard coaster they built" className="w-full h-72 rounded-2xl" fittingType="fill" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-5 py-16 lg:px-8 lg:py-20">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            {[
              { img: "https://media.base44.com/images/public/6a66ade4f704833c85945c24/3f4f208fc_pic24.jpg", alt: "Group of students building catapults together", title: "Flexible, open-ended activities", body: "No two labs feel the same, and neither should two students' experiences. Each lab is crafted with creativity in mind, so students feel their success is theirs — not the directions'." },
