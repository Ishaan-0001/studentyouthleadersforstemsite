...
// In Google Forms, open your form > click "Send" > the < > embed icon,
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-24 pt-36 text-center lg:px-8 lg:pb-28 lg:pt-44">
          <Reveal>
            ...
            <h1 className="font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl text-balance">
              Register for a Lab Near You
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-white/80">
              Select your location, fill in your details, and join a SY-STEM lab near you.
              Sparking curiosity starts here.
            </p>
          </Reveal>
        </div>
      </section>
